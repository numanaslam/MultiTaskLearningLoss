...
config.lambda_cam = 2.5;            % Weight for GradCAM loss
config.lambda_tversky = 5.0;        % Weight for Tversky loss
config.tversky_alpha = 0.7;
config.tversky_beta = 0.45;
config.focal_alpha = [0.3, 0.7];    % [normal, PTB]
...
config.imageAugmenter = imageDataAugmenter( ...
    ...
    'RandRotation', [-30 30], ...
    'RandScale', [0.6 1.4]); % increased from [0.9 1.1]
...
fprintf('  Class weight multiplier: 1.1x for PTB\n');
